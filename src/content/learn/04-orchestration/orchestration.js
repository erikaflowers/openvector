export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'The conductor does not play an instrument. The conductor sees the whole score, knows what comes next, and makes sure every section enters at the right time. That is your job now.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'Sequential vs. Parallel Work',
        body: [
      ...
      {
        type: 'text',
        heading: 'Contracts and Interfaces',
        body: [
      ...
      {
        type: 'text',
        heading: 'Orchestration Anti-Patterns',
        body: [
      ...
      {
        type: 'exercise',
        title: 'Orchestrate a Two-Agent Build',
        body: 'Pick a small feature with a frontend and backend component (a contact form with a submission endpoint, a search page with search API, etc.). Write the contract first: define the exact API endpoint, request format, and response format. Then give the backend task to one Claude Code session and the frontend task to another. Both sessions get the contract as part of their prompt. Build both sides, then integrate. Note where the contract saved you and where you wish you had specified more.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'Designing Data-Intensive Applications by Martin Kleppmann', url: 'https://dataintensive.net/', note: 'The definitive book on distributed systems. Orchestration at the infrastructure level.' },
          { title: 'A Philosophy of Software Design by John Ousterhout', url: 'https://web.stanford.edu/~ouster/cgi-bin/book.php', note: 'On managing complexity through interface design. Directly applicable to agent contracts.' },
          { title: 'Staff Engineer by Will Larson', url: 'https://staffeng.com/book', note: 'On the skill of technical leadership — seeing the whole system and directing the pieces.' },
        ],
      },
    ],
  },
