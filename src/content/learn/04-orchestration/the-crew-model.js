export default {
  ...
  content: {
    sections: [
      {
        type: 'text',
        heading: 'From Assistants to Crew',
        body: [
      ...
      {
        type: 'callout',
        body: 'A crew is not a metaphor. It is an architecture. Each agent has a defined role, defined boundaries, and defined communication channels. You are the director. They are the crew. The project is the production.',
      },
      {
        type: 'text',
        heading: 'Anatomy of a Crew Member',
        body: [
      ...
      {
        type: 'exercise',
        title: 'Design Your Crew',
        body: 'Write the CLAUDE.md for a three-agent crew for a project you care about. Define each agent\'s name, role, domain (specific files and directories), communication style, and coordination rules. Be specific — "owns the frontend" is too vague. "Owns src/components/, src/hooks/, and src/styles/. Does not modify files in api/ or scripts/" is clear. Then run one work session using at least two of the three agents on a real task. Notice how the separation changes the quality of the output.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'Team Topologies by Skelton & Pais', url: 'https://teamtopologies.com/', note: 'The best book on team structure and interaction patterns. Directly applicable to designing agent crews.' },
          { title: 'The Manager\'s Path by Camille Fournier', url: 'https://www.oreilly.com/library/view/the-managers-path/9781491973882/', note: 'On transitioning from individual contributor to technical leader. The same shift happens when you move from solo coding to directing a crew.' },
          { title: 'Anthropic Claude Code Documentation', url: 'https://docs.anthropic.com/en/docs/claude-code', note: 'Official documentation on project files, context management, and multi-session workflows.' },
        ],
      },
    ],
  },
