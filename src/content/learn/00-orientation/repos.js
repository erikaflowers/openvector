export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'A repository is a project with memory. It knows every version of every file that was ever committed, who changed it, and why.',
      },
      {
        type: 'text',
        heading: 'Cloning',
      ...
      {
        type: 'text',
        heading: 'Key Files You Will See',
        body: [
      ...
      {
        type: 'code',
        body: '# Push your commits to the remote\ngit push origin main\n\n# Pull the latest changes from the remote\ngit pull origin main\n\n# Connect a local repo to a new remote\ngit remote add origin https://github.com/username/my-project.git\ngit push -u origin main',
      },
      {
        type: 'exercise',
        title: 'Clone and Explore',
        body: 'Go to github.com and find any public repository that interests you (or search for "awesome" lists — they are curated collections of tools and resources). Copy the clone URL (the green "Code" button → HTTPS URL). Open your terminal, navigate to where you keep projects (cd ~/Desktop or similar), and run git clone <paste-url-here>. Enter the folder with cd <project-name>. Run ls -la to see the file structure. Run cat README.md to read the project description right in your terminal. Run git log --oneline to see the commit history. You are now inside someone else\'s project, reading their work, and seeing their history.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'GitHub Hello World Guide', url: 'https://docs.github.com/en/get-started/start-your-journey/hello-world', note: 'GitHub\'s official walkthrough for creating your first repository.' },
          { title: 'GitHub Skills', url: 'https://skills.github.com/', note: 'Free interactive courses that teach GitHub workflows step by step.' },
          { title: 'The Missing Semester — Version Control', url: 'https://missing.csail.mit.edu/2020/version-control/', note: 'MIT\'s deep dive into Git internals. Goes further than you need right now — bookmark it for later.' },
          { title: 'Awesome README', url: 'https://github.com/matiassingers/awesome-readme', note: 'A curated list of excellent README files for inspiration when writing your own.' },
        ],
      },
    ],
  },
