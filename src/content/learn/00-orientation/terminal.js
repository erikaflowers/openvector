export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'The terminal is not scary. It is direct. You are not clicking through menus hoping to find the right option. You are telling the computer exactly what to do.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'Tab Completion and History',
        body: [
      ...
      {
        type: 'exercise',
        title: 'Navigate, Create, Explore',
        body: 'Open your terminal. Run pwd to see where you are. Run cd ~/Desktop to navigate to your Desktop (or cd $HOME/Desktop on some systems). Run mkdir terminal-practice to create a folder. Run cd terminal-practice to go inside it. Run touch hello.txt to create a file. Run ls to confirm it is there. Run cat hello.txt — it is empty, that is fine. Run cd .. to go back up. You just navigated, created, and explored. That is 90% of terminal use.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'The Missing Semester of Your CS Education', url: 'https://missing.csail.mit.edu/', note: 'MIT course covering the tools nobody teaches you. Start with Lecture 1: The Shell.' },
          { title: 'Command Line Power User', url: 'https://commandlinepoweruser.com/', note: 'Free video series by Wes Bos. Quick, practical, well-produced.' },
          { title: 'explainshell.com', url: 'https://explainshell.com/', note: 'Paste any command and it breaks down every part. Brilliant learning tool.' },
          { title: 'Linux Command Library', url: 'https://linuxcommandlibrary.com/', note: 'Searchable reference for every command. Works for Mac too (they share most commands).' },
        ],
      },
    ],
  },
