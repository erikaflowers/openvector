export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'Git is not a backup system. It is a time machine you control. Every commit is a deliberate checkpoint that you chose to create, with a message explaining why.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'When Things Feel Scary',
        body: [
      ...
      {
        type: 'callout',
        body: 'When in doubt, commit. You can always reorganize history later. But you cannot recover work you never committed.',
      },
      {
        type: 'exercise',
        title: 'Your First Repository',
        body: 'Open your terminal. Create a project folder: mkdir git-practice && cd git-practice. Initialize Git: git init. You should see "Initialized empty Git repository." Create a file: touch README.md. Run git status — it shows README.md as untracked. Stage it: git add README.md. Run git status again — it is now staged. Commit: git commit -m "Initial commit with README". Run git log to see your first commit. Now open README.md in any text editor, add a line of text, save it. Run git diff — you can see exactly what changed. Stage and commit: git add . && git commit -m "Add description to README". Run git log — you now have two commits. You have a time machine.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'Pro Git (free book)', url: 'https://git-scm.com/book/en/v2', note: 'The definitive Git reference. Chapters 1-3 cover everything a beginner needs.' },
          { title: 'Oh Shit, Git!?!', url: 'https://ohshitgit.com/', note: 'A brilliant, profanity-laced guide to getting out of common Git messes. Bookmark this.' },
          { title: 'GitHub Git Handbook', url: 'https://docs.github.com/en/get-started/using-git/about-git', note: 'GitHub\'s concise introduction to Git concepts.' },
          { title: 'Learn Git Branching', url: 'https://learngitbranching.js.org/', note: 'Interactive visual tutorial. Teaches branching with animated diagrams.' },
        ],
      },
    ],
  },
