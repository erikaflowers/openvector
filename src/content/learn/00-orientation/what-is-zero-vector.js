export default {
  ...
  content: {
    sections: [
      {
        type: 'text',
        heading: 'What Is Zero Vector Design?',
        body: [
      ...
      {
        type: 'text',
        heading: 'This Is Not Vibe Coding',
        body: [
      ...
      {
        type: 'callout',
        body: 'AI agents are crew, not replacement. You are the director. They are specialists who execute under your vision. The quality of the output depends on the quality of your direction.',
      },
      {
        type: 'text',
        heading: 'What This Curriculum Covers',
        body: [
      ...
      {
        type: 'text',
        heading: 'Who Made This and Why It\'s Free',
        body: [
      ...
      },
      {
        ...
        body: 'Make sure you have: a computer (Mac, Windows, or Linux — all work), an internet connection (you will be installing tools and cloning repositories), willingness to type commands (this curriculum uses the terminal extensively — if that feels unfamiliar, good, that is why Level 00 exists), and curiosity (the most important prerequisite is wanting to understand how things work, not just that they work). You do not need prior coding experience. You do not need a computer science degree. You do not need to know what a terminal is yet. That is what the next lesson teaches.',
      },
      {
        type: 'resources',
        heading: 'Links',
        items: [
          { title: 'Zero Vector Design', url: 'https://zerovector.design', note: 'The Zero Vector Design home.' },
          { title: 'The Zero Vector Manifesto', url: 'https://zerovector.design/philosophy', note: 'The philosophy in full.' },
          { title: 'Substack: Erika Flowers', url: 'https://eflowers.substack.com', note: 'Essays on the methodology and the movement.' },
        ],
      },
    ],
  },
  knowledgeCheck: [
    { question: 'What is the difference between Zero Vector Design and vibe coding?', hint: 'Think about intent, architecture, and understanding the system vs. reactive prompting.' },
    { question: 'What does "Auteur" mean in the context of this curriculum?', hint: 'Think about the film director analogy — vision, direction, and crew.' },
  ],
};
