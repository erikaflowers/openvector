export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'Shipping is not the end of the process. It is the beginning of the real learning. Everything before shipping is hypothesis. Everything after is data.',
      },
      {
        type: 'text',
        heading: 'The Ship Checklist',
        body: [
      ...
      {
        type: 'text',
        heading: 'Feedback Loops After Launch',
        body: [
      ...
      },
      {
        ...
        body: 'Take the project you have built through this level (or any project you have been working on). Ship it. Deploy it, share the URL with at least three people, and ask them to use it. Collect feedback for one week. At the end of the week, write a one-page reflection: What did users do that surprised you? What was the most common complaint? What feature request came up more than once? What would you prioritize for version 2? This reflection is the beginning of your next cycle through the pipeline.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'Shape Up by Basecamp', url: 'https://basecamp.com/shapeup', note: 'How to scope, build, and ship in six-week cycles. The best book on shipping discipline.' },
          { title: 'The Practice by Seth Godin', url: 'https://seths.blog/thepractice/', note: 'On the discipline of shipping creative work. "Ship before you are ready."' },
          { title: 'Indie Hackers', url: 'https://www.indiehackers.com/', note: 'A community of people building and shipping products independently. Inspiring case studies and honest retrospectives.' },
          { title: 'Building in Public (Kevon Cheung)', url: 'https://www.buildinpublic.com/', note: 'A guide to sharing your building process and creating an audience around your work.' },
        ],
      },
    ],
  },
