export default {
  slug: 'validation',
  title: 'Validation',
  subtitle: 'Test the real thing, not a picture of it.',
  duration: '18 min',
  status: 'available',
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'Validation is not about proving you are right. It is about finding out what is true. The most valuable outcome is learning what you got wrong — because now you can fix it.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'The Task-Based Approach',
        body: [
      ...
      {
        type: 'text',
        heading: 'Pivot, Persevere, or Iterate',
        body: [
      ...
      {
        type: 'exercise',
        title: 'Test with Three People',
        body: 'Take your prototype from the previous lesson. Write three tasks that a user should be able to accomplish. Find three people (friends, family, colleagues — anyone who is not you). Give them the tasks one at a time and watch them work. Do not help unless they are truly stuck. After all tasks, ask: "What was the hardest part?" and "Would you use this again?" Write down every problem you observed, ranked by severity. You now have a validated, prioritized list of what to fix next.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'Rocket Surgery Made Easy by Steve Krug', url: 'https://www.sensible.com/rocket-surgery-made-easy/', note: 'The most practical guide to usability testing ever written. You can run your first test today.' },
          { title: 'Don\'t Make Me Think by Steve Krug', url: 'https://www.sensible.com/dont-make-me-think/', note: 'The classic on web usability. Short, visual, and immediately applicable.' },
          { title: 'Nielsen Norman Group: Usability Testing 101', url: 'https://www.nngroup.com/articles/usability-testing-101/', note: 'A thorough introduction to usability testing methodology from the leaders in the field.' },
          { title: 'The Lean Startup — Build-Measure-Learn', url: 'http://theleanstartup.com/', note: 'The framework for validated learning that JTBD and prototyping feed into.' },
        ],
      },
    ],
  },
