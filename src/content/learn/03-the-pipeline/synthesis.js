export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'Synthesis is not about the data you collected. It is about the meaning you extract. Two designers looking at the same research will synthesize different insights — and that is the value.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'From Synthesis to Action',
        body: [
      ...
      },
      {
        ...
        body: 'Take the research from the previous lesson (or use product reviews from an app you use). Write each distinct observation on a separate line in a document (or physical sticky notes). Group related observations together. Name each group with a theme. Write one insight statement per group — not a summary of what people said, but an interpretation of what it means. You should end up with 3-5 insight statements that tell a coherent story about what your users actually need.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'Abby Covert: How to Make Sense of Any Mess', url: 'https://www.howtomakesenseofanymess.com/', note: 'Organizing information is what synthesis is about. This free book covers the fundamentals.' },
          { title: 'Miro (Collaborative Whiteboard)', url: 'https://miro.com/', note: 'Digital whiteboard for affinity mapping and synthesis. Free tier available.' },
          { title: 'IDEO Design Thinking', url: 'https://designthinking.ideo.com/', note: 'IDEO\'s framework for design thinking includes excellent synthesis techniques.' },
          { title: 'Synthesizing Research by Indi Young', url: 'https://indiyoung.com/', note: 'Indi Young\'s work on mental model diagrams is the deepest dive into synthesis methodology.' },
        ],
      },
    ],
  },
