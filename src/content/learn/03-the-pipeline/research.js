export default {
  ...
  content: {
    sections: [
      {
        type: 'text',
        heading: 'Why Research Comes First',
        body: [
      ...
      {
        type: 'callout',
        body: 'The most expensive feature you will ever build is the one nobody uses. Research is cheap. Building the wrong thing is not.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'Documenting What You Find',
        body: [
      ...
      },
      {
        ...
        body: 'Pick a problem you want to solve (or a product category you find interesting). Spend 30 minutes on desk research: look at three competing products, read their reviews (especially negative ones), and find one community forum where people discuss the problem. Write down the top five pain points you discovered. Now write three interview questions you would ask a real user. If you can, actually ask someone — a friend, a colleague, a family member who fits the audience. Compare what they say to what you found online.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'Just Enough Research by Erika Hall', url: 'https://abookapart.com/products/just-enough-research', note: 'The best book on practical research for builders. Short, opinionated, and actionable.' },
          { title: 'The Mom Test by Rob Fitzpatrick', url: 'https://www.momtestbook.com/', note: 'How to talk to customers without getting lied to. Essential reading on interview technique.' },
          { title: 'Nielsen Norman Group: User Research Methods', url: 'https://www.nngroup.com/articles/which-ux-research-methods/', note: 'A comprehensive overview of when to use which research method.' },
        ],
      },
    ],
  },
