export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'A framework is an opinion about how work should be done, encoded into a reusable structure. The opinion is the hard part. The structure is just the packaging.',
      },
      {
        type: 'text',
        heading: 'When to Build a Framework',
        body: [
      ...
      {
        type: 'text',
        heading: 'The Anatomy of a Good Framework',
        body: [
      ...
      {
        type: 'text',
        heading: 'Design Frameworks vs. Code Frameworks',
        body: [
      ...
      {
        type: 'text',
        heading: 'The Opinionated Default',
        body: [
      ...
      {
        type: 'text',
        heading: 'Testing Your Framework',
        body: [
          'A framework is tested by having someone else use it. Not by reading documentation — by actually building something with it. Watch them. Where do they get stuck? What do they misunderstand? What is missing?',
          ...
          'The second test is time. Use your own framework for a month. The excitement of creation fades. Daily use reveals the friction: the naming that seemed clever is actually confusing, the default that seemed sensible is actually wrong, the pattern that seemed elegant is actually cumbersome.',
        ],
      },
      {
        type: 'exercise',
        title: 'Extract a Framework',
        body: 'Look at your last three projects. Find one thing you did in all three: a project structure, a naming convention, a way of organizing components, a checklist you followed. Extract it into a reusable template or document. Give it a name. Write a one-paragraph description of what it does and when to use it. Then start your next project using it. Note where it helps and where it needs adjustment.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'A Philosophy of Software Design by John Ousterhout', url: 'https://web.stanford.edu/~ouster/cgi-bin/book.php', note: 'The best book on designing interfaces and managing complexity. Essential reading for framework designers.' },
          { title: 'Design Systems by Alla Kholmatova', url: 'https://www.smashingmagazine.com/design-systems-book/', note: 'How to build a design system — which is a framework for design. Practical and well-structured.' },
          { title: 'The Pragmatic Programmer by Hunt & Thomas', url: 'https://pragprog.com/titles/tpp20/', note: 'The chapter on "Don\'t Repeat Yourself" and "Orthogonality" are the philosophical foundation of framework design.' },
        ],
      },
    ],
  },
