export default {
  slug: 'personal-methodology',
  title: 'Personal Methodology',
  subtitle: 'Your way of working, codified.',
  duration: '22 min',
  status: 'available',
  content: {
    sections: [
      {
        type: 'text',
        heading: 'Beyond Following the Process',
        body: [
      ...
      {
        type: 'callout',
        body: 'A methodology is not a set of rules you follow. It is a set of principles you have internalized. You do not consult the checklist anymore — you feel when something is missing.',
      },
      {
        type: 'text',
        heading: 'What Is a Methodology?',
        body: [
      ...
      {
        type: 'text',
        heading: 'The Components of a Methodology',
        body: [
      ...
      {
        type: 'text',
        heading: 'Documenting Your Methodology',
        body: [
      ...
      {
        type: 'text',
        heading: 'Evolving Through Practice',
        body: [
      ...
      {
        type: 'exercise',
        title: 'Write Your Methodology v1',
        body: 'On one page (or one screen), write your current personal methodology. Include: how you start a project (three steps), how you decide between options (one framework), what "good enough" means (two criteria), what you do when stuck (one pattern), and how you finish (two steps). Keep each point to one sentence. This is version one. Pin it where you can see it. Revisit it after your next three projects and revise.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'The Practice by Seth Godin', url: 'https://seths.blog/thepractice/', note: 'On developing a creative practice. The best short book on the discipline of doing the work consistently.' },
          { title: 'Atomic Habits by James Clear', url: 'https://jamesclear.com/atomic-habits', note: 'On building systems instead of setting goals. Your methodology is your system.' },
          { title: 'Reflective Practice by Donald Schon', url: 'https://en.wikipedia.org/wiki/Reflective_practice', note: 'The academic foundation for learning from your own practice. Heavy but foundational.' },
        ],
      },
    ],
  },
