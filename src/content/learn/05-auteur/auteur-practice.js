export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'An auteur is not a genius working alone. An auteur is a person with a clear vision and the skill to realize it through others. The vision is the irreplaceable part. Everything else can be delegated.',
      },
      {
        type: 'text',
        heading: 'Vision as a Skill',
        body: [
      ...
      {
        type: 'text',
        heading: 'Building Your Body of Work',
        body: [
      ...
      {
        type: 'text',
        heading: 'The Zero Vector Promise',
        body: [
      ...
      {
        type: 'exercise',
        title: 'Your Auteur Statement',
        body: 'Write a one-page auteur statement. It should answer three questions: What do I build and why does it matter? How do I work — what is my methodology in three sentences? What is the standard I hold my work to — what makes me say "this is good enough to ship"? This statement is your north star. Not a resume, not a bio — a declaration of your practice. Revise it every six months. Watch how it evolves as you do.',
      },
      {
        type: 'resources',
        heading: 'Go Deeper',
        items: [
          { title: 'The Practice by Seth Godin', url: 'https://seths.blog/thepractice/', note: 'The definitive book on creative practice. "Ship before you are ready." The philosophy behind everything in this lesson.' },
          { title: 'Steal Like an Artist by Austin Kleon', url: 'https://austinkleon.com/steal/', note: 'On finding your voice by studying others. Your vision is the sum of your influences, remixed through your perspective.' },
          { title: 'The War of Art by Steven Pressfield', url: 'https://stevenpressfield.com/books/the-war-of-art/', note: 'On the resistance that stands between you and your practice. Short, fierce, and essential.' },
          { title: 'Zero Vector Manifesto', url: 'https://zerovector.design', note: 'Where this all began. The principles behind the curriculum you just completed.' },
        ],
      },
    ],
  },
