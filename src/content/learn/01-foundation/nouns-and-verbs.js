export default {
  ...
  content: {
    sections: [
      {
        type: 'text',
        heading: 'The Most Powerful Design Exercise',
        body: [
      ...
      {
        type: 'callout',
        body: 'If you can describe what your software does in two paragraphs, you can extract a working architecture from those paragraphs. The nouns are what you store. The verbs are what you build.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'Nouns Become Structure',
        body: [
      ...
      {
        type: 'text',
        heading: 'Hidden Nouns and Verbs',
        body: [
      ...
      {
        type: 'text',
        heading: 'From Nouns & Verbs to AI Prompts',
        body: [
      ...
      },
      {
        ...
        heading: 'Go Deeper',
        items: [
          { title: 'Domain-Driven Design Quickly', url: 'https://www.infoq.com/minibooks/domain-driven-design-quickly/', note: 'A free minibook introducing DDD — the professional version of Nouns & Verbs. Focuses on modeling real domains.' },
          { title: 'Object-Oriented Analysis and Design (Head First)', url: 'https://www.oreilly.com/library/view/head-first-object-oriented/0596008678/', note: 'A visual, beginner-friendly take on turning requirements into object models.' },
          { title: 'Event Storming', url: 'https://www.eventstorming.com/', note: 'A collaborative workshop technique for discovering the verbs (events) in a system. Used by professional architects.' },
          { title: 'React: Describing the UI', url: 'https://react.dev/learn/describing-the-ui', note: 'How React turns the "nouns" of your interface into a component tree.' },
        ],
      },
    ],
  },
