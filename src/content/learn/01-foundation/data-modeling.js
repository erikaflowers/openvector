export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'If you change the shape of your data, you change everything that touches it. Get the data model right early, and you save yourself from the most expensive kind of refactoring.',
      },
      {
        type: 'text',
        heading: 'Entities and Fields',
        body: [
      ...
      {
        type: 'text',
        heading: 'JSON: The Shape You Will See Most',
        body: [
      ...
      },
      {
        ...
        heading: 'Go Deeper',
        items: [
          { title: 'Prisma Data Modeling Guide', url: 'https://www.prisma.io/dataguide', note: 'Prisma\'s free guide to data modeling fundamentals. Clear explanations with diagrams.' },
          { title: 'JSON.org', url: 'https://www.json.org/', note: 'The specification for JSON in one page. Everything you need to know about the format.' },
          { title: 'Database Design for Mere Mortals', url: 'https://www.oreilly.com/library/view/database-design-for/9780136788041/', note: 'The classic beginner book on relational database design. No jargon.' },
          { title: 'Supabase Schema Visualizer', url: 'https://supabase.com/dashboard', note: 'If you create a free Supabase project, the schema visualizer lets you see your tables and relationships graphically.' },
        ],
      },
    ],
  },
