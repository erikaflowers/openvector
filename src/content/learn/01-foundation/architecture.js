export default {
  ...
  content: {
    sections: [
      {
        type: 'text',
        heading: 'What Is Software Architecture?',
        body: [
      ...
      {
        type: 'callout',
        body: 'Architecture is not about making things complicated. It is about deciding what goes where so that adding, changing, and fixing things stays manageable as the project grows.',
      },
      {
        type: 'text',
        heading: 'Why Architecture Before Code',
        body: [
          ...
          'When you start coding without thinking about structure, you are making architectural decisions by default. The decisions get made — you just do not realize you are making them. And default decisions tend to be bad ones, because they optimize for "what is easiest right now" rather than "what will make sense next month."',
      ...
      {
        type: 'text',
        heading: 'The Architecture of a Real Project',
        body: [
      ...
      },
      {
        ...
        heading: 'Go Deeper',
        items: [
          { title: 'Patterns.dev', url: 'https://www.patterns.dev/', note: 'Free book on design and rendering patterns for modern web apps. Visual, practical, and current.' },
          { title: 'The Twelve-Factor App', url: 'https://12factor.net/', note: 'Twelve principles for building modern, maintainable software. Written by Heroku\'s co-founder.' },
          { title: 'A Philosophy of Software Design by John Ousterhout', url: 'https://web.stanford.edu/~ouster/cgi-bin/book.php', note: 'Stanford CS professor on managing complexity. One of the best books on software architecture.' },
          { title: 'React: Thinking in React', url: 'https://react.dev/learn/thinking-in-react', note: 'The official guide to decomposing a UI into components. The best starting point for component architecture.' },
        ],
      },
    ],
  },
