export default {
  ...
  content: {
    sections: [
      ...
      {
        type: 'callout',
        body: 'You do not need to become a systems engineer. You need to develop the habit of asking: "What is this connected to, and what happens when it changes?"',
      },
      {
        type: 'text',
        heading: 'Why Designers Need This',
        body: [
          'Design has always been systems work — we just did not always call it that. A design system is literally in the name. A user journey maps connections between touchpoints. Service design maps entire ecosystems of people, processes, and technology.',
      ...
      {
        type: 'text',
        heading: 'Thinking in Dependencies',
        body: [
      ...
      },
      {
        ...
        heading: 'Go Deeper',
        items: [
          { title: 'Thinking in Systems by Donella Meadows', url: 'https://www.chelseagreen.com/product/thinking-in-systems/', note: 'The foundational text on systems thinking. Short, brilliant, and accessible. Start here.' },
          { title: 'The Systems Thinker', url: 'https://thesystemsthinker.com/', note: 'Articles and diagrams on systems thinking applied to organizations and design.' },
          { title: 'Loopy — A Tool for Thinking in Systems', url: 'https://ncase.me/loopy/', note: 'An interactive tool for building and simulating feedback loops. By Nicky Case.' },
          { title: 'Leverage Points by Donella Meadows', url: 'https://donellameadows.org/archives/leverage-points-places-to-intervene-in-a-system/', note: 'The famous essay on where to intervene in a system for maximum effect.' },
        ],
      },
    ],
  },
