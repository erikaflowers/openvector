export default {
  ...
  content: {
    sections: [
      {
        type: 'text',
        heading: 'Why Planning Matters More with AI',
        body: [
      ...
      {
        type: 'callout',
        body: 'A plan is not a promise. It is a snapshot of your current understanding. The plan will change — that is fine. The act of making it forces clarity that no amount of improvisation can replace.',
      },
      {
        type: 'text',
      ...
      {
        type: 'text',
        heading: 'Scope Creep and the Art of "Later"',
        body: [
      ...
      {
        type: 'text',
        heading: 'Planning for AI Collaboration',
        body: [
      ...
      },
      {
        ...
        heading: 'Go Deeper',
        items: [
          { title: 'Shape Up by Basecamp', url: 'https://basecamp.com/shapeup', note: 'A free book on how to scope and plan projects. "Shaping" is professional decomposition. Brilliant and practical.' },
          { title: 'The Mythical Man-Month (essays)', url: 'https://en.wikipedia.org/wiki/The_Mythical_Man-Month', note: 'Classic software engineering wisdom. The chapter on conceptual integrity is about planning.' },
          { title: 'Getting Real by Basecamp', url: 'https://basecamp.com/gettingreal', note: 'A manifesto on building less and shipping faster. The chapter on scope is gold.' },
          { title: 'CLAUDE.md: Writing Instructions for AI', url: 'https://docs.anthropic.com/en/docs/claude-code/tutorials#create-a-claude-md-file', note: 'How to write a CLAUDE.md file — your plan for AI collaboration.' },
        ],
      },
    ],
  },
