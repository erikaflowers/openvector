...
- [Abby Covert: How to Make Sense of Any Mess](https://www.howtomakesenseofanymess.com/). Organizing information is what synthesis is about. This free book covers the fundamentals.
- [Miro (Collaborative Whiteboard)](https://miro.com/). Digital whiteboard for affinity mapping and synthesis. Free tier available.
- [IDEO Design Thinking](https://designthinking.ideo.com/). IDEO's framework for design thinking includes excellent synthesis techniques.
- [Synthesizing Research by Indi Young](https://indiyoung.com/). Indi Young's work on mental model diagrams is the deepest dive into synthesis methodology.
:::
