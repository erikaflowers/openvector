...
Write it down. Not as a rigid procedure manual, but as a living reference that captures your current best thinking about how you work.
...
- [The Practice by Seth Godin](https://seths.blog/thepractice/). On developing a creative practice. The best short book on the discipline of doing the work consistently.
- [Atomic Habits by James Clear](https://jamesclear.com/atomic-habits). On building systems instead of setting goals. Your methodology is your system.
- [Reflective Practice by Donald Schon](https://en.wikipedia.org/wiki/Reflective_practice). The academic foundation for learning from your own practice. Heavy but foundational.
:::
